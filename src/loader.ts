/**
 * Don't edit file
 * copy from https://github.com/grpc/grpc-node/blob/master/packages/grpc-protobufjs/src/index.ts
 *
 * @license
...
export function loadFromJson(json: INamespace, options?: Options): PackageDefinition {
  const root: Protobuf.Root = Protobuf.Root.fromJSON(json, new Protobuf.Root());
  root.resolveAll();
  return createPackageDefinition(root, options);
}
